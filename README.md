...
<details>
  ...
  <p>Once I saw how the program was working from the example from <a href="https://www.geeksforgeeks.org/bankers-algorithm-in-operating-system-2/" target="_blank">geeksforgeeks.org</a>[^1], it made a lot more sense to me.</p>
  ...
  [^1]: Tried to get it to open a new tab on the browser but it refused to use the target="_blank".
</details>
